...
const ClothesGrid = ({ heading, products }) => {
  return (
    <div className="OuterMost flex justify-center items-center px-4">
      <div className="OuterOne flex justify-center items-center w-full max-w-[1440px] pt-16 pb-16">
        <div className="ContentBox grid justify-center items-center gap-14 w-full">
          ...
          <div className="Product grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 flex-wrap gap-8 items-center">
              ...
              <div key={product.id} className="ProductItem flex">
                ...
                >
                  ...
                  <div className="w-full text-left  grid gap-2">
                    <h4 className="ItemName text-left text-[15px] lg:!text-[20px] sm:text-[20px] leading-[27px] font-bold">
                      {product.name}
                    </h4>
